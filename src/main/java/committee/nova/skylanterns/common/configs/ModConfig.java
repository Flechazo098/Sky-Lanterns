...
public class ModConfig {
    ...
    public static class Common {
        public final ModConfigSpec.ConfigValue<Integer> lightUpdateRate, lightUpdateDistanceAccuracy, lightUpdateDistanceToGround;
        public final ModConfigSpec.ConfigValue<Boolean> enableLanternShader;
